...
The coefficient type is generic over `Float` (in practice `f32` and `f64`),
and the input/output/state type can be chosen independently (e.g. for SIMD),
defaulting to the coefficient type.
